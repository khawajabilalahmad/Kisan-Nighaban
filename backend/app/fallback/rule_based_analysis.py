from app.schemas.analysis import FarmAnalysisOutput, AnalysisBreakdown, Recommendation

def calculate_rule_based_analysis(
    crop_type: str, 
    crop_profile: dict, 
    weather_data: dict, 
    growth_stage: str, 
    ...
    """
    Fallback method to calculate health scores using hard-coded rules and thresholds
    ...
    summary = f"Rule-based analysis indicates a {health_status} risk level. "
    if overall_score > 50:
